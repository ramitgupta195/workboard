...
export const PERMISSION_DEFS = [
  ...
  { key: 'view_files',         label: 'View files',          description: 'Browse and download attachments in File Explorer' },
  { key: 'delete_files',       label: 'Delete files',        description: 'Permanently remove attachments via File Explorer' },
];
