    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-indigo-800 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-sm p-8 animate-slide-up">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-slate-100">Workboard</h1>
          <p className="text-gray-500 dark:text-slate-400 text-sm mt-1">Sign in to your workspace</p>
        </div>
